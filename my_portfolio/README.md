...
when we create a folder with () for example (groupAuth) , if we want to search for the files in this folder we should not write Auth in the path for example

dashboard/groupAuth/login --> false
dashboard/login --> true  (access directly)
