  ...
  return (
    <div className={styles.containers}>
        <div className={styles.imgContainer}> 
          ...
          <h1 className={styles.imgDesc}> You want to build a website!</h1>
          <h2 className={styles.imgTitle}>Looking to build a new website or upgrade your existing website to a web application?</h2>
          </div>
        </div>
